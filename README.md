...
## LLM Usage
Since I have never had the chance to work with Rust, I could only make use of the agentic-development capabilities of github copilot to work on the majority of the rust code in this repository. I only intervened in the development process to understand the flow of information and to see if there are any severe errors in the inference pipeline. The entire "rust" code was vibe-coded. 
